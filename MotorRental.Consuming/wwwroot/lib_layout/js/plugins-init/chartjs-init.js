 ...
 var dzSparkLine = function(){
					...
					datasets: [
						{
							...
							borderColor: 'rgba(135, 67, 223, 1)',
							borderWidth: "0",
							backgroundColor: 'rgba(135, 67, 223, 1)',
							//barThickness : '50'
							barPercentage: 0.5,
						}
					]
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			barChart_2gradientStroke.addColorStop(0, "rgba(135, 67, 223, 1)");
			barChart_2gradientStroke.addColorStop(1, "rgba(135, 67, 223, 0.5)");
	...
	var barChart3 = function(){
		...
		if(jQuery('#barChart_3').length > 0 ){
			...
			barChart_3gradientStroke.addColorStop(0, "rgba(135, 67, 223, 1)");
			barChart_3gradientStroke.addColorStop(1, "rgba(135, 67, 223, 0.5)");
		...
		//basic line chart
			...
			class Custom extends Chart.LineController {
				draw() {
					...
					ctx.stroke = function(){
						ctx.save();
						ctx.shadowColor = 'rgba(135, 67, 233, 0.2)';
						ctx.shadowBlur = 10;
						ctx.shadowOffsetX = 0;
						ctx.shadowOffsetY = 4;
					...
					datasets: [
						{
							...
							tension:0.5,							
							pointBackgroundColor: 'rgba(135, 67, 223, 1)'
						}
					]
				},
				options: {
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			lineChart_2gradientStroke.addColorStop(0, "rgba(135, 67, 223, 1)");
			lineChart_2gradientStroke.addColorStop(1, "rgba(135, 67, 223, 0.5)");
					...
					datasets: [
						{
							...
							backgroundColor: 'transparent', 
							tension:0.5,
							pointBackgroundColor: 'rgba(135, 67, 223, 0.5)'
						}
					]
				},
				options: {
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke1.addColorStop(0, "rgba(135, 67, 223, 1)");
			lineChart_3gradientStroke1.addColorStop(1, "rgba(135, 67, 223, 0.5)");

			const lineChart_3gradientStroke2 = lineChart_3.createLinearGradient(500, 0, 100, 0);
			lineChart_3gradientStroke2.addColorStop(0, "rgba(255, 155, 82, 1)");
			lineChart_3gradientStroke2.addColorStop(1, "rgba(255, 155, 82, 1)");
					...
					datasets: [
						{
							...
							borderWidth: "1",
							backgroundColor: 'rgba(135, 67, 223, .5)', 
							tension:0.5,
							fill:true,
				...
				data: {
					...
					datasets: [
						...
						}, 
						{
							...
							tension:0.5,
							fill:true,
							backgroundColor: 'rgba(255, 155, 82, .5)'
						}
					]
				},
				options: {
