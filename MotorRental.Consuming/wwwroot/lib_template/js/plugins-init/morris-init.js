	...
	var dzMorris = function(){
		...
		var donutChart = function(){
			Morris.Donut({
				...
				resize: true,
				redraw: true,
				colors: ['#2D28FF', 'rgb(135, 67, 223)', '#1bd084'],
				//responsive:true,
		...
		var lineChart = function(){
			...
			let line = new Morris.Line({
				...
				lineColors: ['rgb(135, 67, 223)'], //here
				lineWidth: 1,
				hideHover: 'auto',
				pointSize: 0,
				axes: false
		...
		var lineChart2 = function(){
			...
			Morris.Area({
				...
				pointSize: 3,
				fillOpacity: 0,
				pointStrokeColors: ['#ff6746', '#1bd084', '#2D28FF'],
				behaveLikeLine: true,
				gridLineColor: 'transparent',
				lineWidth: 3,
				hideHover: 'auto',
				lineColors: ['rgb(135, 67, 223)', 'rgb(27, 208, 132)', '#2D28FF'],
				resize: true
		...
		var barChart = function(){
			...
			Morris.Bar({
				...
				ykeys: ['a', 'b', 'c'],
				labels: ['A', 'B', 'C'],
				barColors: ['#8743DF', '#1bd084', '#ff9f00'],
				hideHover: 'auto',
				gridLineColor: 'transparent',
				resize: true,
				barSizeRatio: 0.25,
		...
		var areaChart = function(){
			...
			Morris.Area({
				...
				lineColors: ['#2D28FF', 'rgb(16, 202, 147)', 'rgb(135, 67, 223)'],
				xkey: 'period',
				ykeys: ['smartphone', 'windows', 'mac'],
				labels: ['Phone', 'Windows', 'Mac'],
				pointSize: 0,
